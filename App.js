...
export default function App() {
  ...
  const onPress = (rowIndex, columnIndex) => {
    if (map[rowIndex][columnIndex] !== "") {
      Alert.alert("This Position already occupied");
      return;
    }
      ...
      <ImageBackground source={bg} style={styles.bg} resizeMode="contain">
        ...
        <View style={styles.buttons}>
          <Text
            ...
            style={[
              styles.button,
              { backgroundColor: gameMode === "LOCAL" ? "#316d70" : "#b6aa78" },
            ]}
          >
            Local
          </Text>
          <Text
            ...
            style={[
              ...
              {
                backgroundColor:
                  gameMode === "BOT_EASY" ? "#3ab246" : "#b6aa78",
              },
            ]}
          >
            Easy Mode
          ...
          <Text
            ...
            style={[
              ...
              {
                backgroundColor:
                  gameMode === "BOT_MEDIUM" ? "#ffb039" : "#b6aa78",
              },
            ]}
          >
            Medium Mode
